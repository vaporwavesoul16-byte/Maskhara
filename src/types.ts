...
export const SECTION_BG: Record<SectionKey, string> = {
  services: 'rgba(59,123,255,0.04)',
  clients:  'rgba(44,184,122,0.04)',
  identity: 'rgba(212,168,67,0.04)',
  projects: 'rgba(194,59,34,0.04)',
  notes:    'rgba(139,92,246,0.04)',
  custom:   'rgba(255,255,255,0.02)',
};
